...
impl SharedMemoryBuffer {
    ...
    pub fn new_read_buffer<T: AsRef<str>>(
        ...
        let buffer_ptr = ebutils::align_up_pow2(
...
impl SharedMemoryBuffer {
    ...
    fn initialize_shared_memory(
        ...
        let aligned_buffer_size = ebutils::align_up_pow2(size, alignment_pow2);
    ...
    fn create_mapped_shared_memory(
        ...
        let aligned_header_size = ebutils::align_up_pow2(header_size, alignment_pow2);
        let aligned_buffer_size = ebutils::align_up_pow2(size, alignment_pow2);
