...
## What is an MFP?
A multi fragment packet (MFP) is a collection of fragments, pieces of some physics data, from one specific part of a sub-detector at LHCb and multiple collision events.
