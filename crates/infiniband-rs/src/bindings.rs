...
impl ibv_odp_transport_cap_bits {
    ...
    pub const IBV_ODP_SUPPORT_FLUSH: ibv_odp_transport_cap_bits = ibv_odp_transport_cap_bits(64);
    pub const IBV_ODP_SUPPORT_ATOMIC_WRITE: ibv_odp_transport_cap_bits =
        ibv_odp_transport_cap_bits(128);
}
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ibv_dmah"][::std::mem::size_of::<ibv_dmah>() - 8usize];
    ["Alignment of ibv_dmah"][::std::mem::align_of::<ibv_dmah>() - 8usize];
    ["Offset of field: ibv_dmah::context"][::std::mem::offset_of!(ibv_dmah, context) - 0usize];
};
impl Default for ibv_dmah {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum ibv_mr_init_attr_mask {
    IBV_REG_MR_MASK_IOVA = 1,
    IBV_REG_MR_MASK_ADDR = 2,
    IBV_REG_MR_MASK_FD = 4,
    IBV_REG_MR_MASK_FD_OFFSET = 8,
    IBV_REG_MR_MASK_DMAH = 16,
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ibv_mr_init_attr"][::std::mem::size_of::<ibv_mr_init_attr>() - 64usize];
    ["Alignment of ibv_mr_init_attr"][::std::mem::align_of::<ibv_mr_init_attr>() - 8usize];
    ["Offset of field: ibv_mr_init_attr::length"]
        [::std::mem::offset_of!(ibv_mr_init_attr, length) - 0usize];
    ["Offset of field: ibv_mr_init_attr::access"]
        [::std::mem::offset_of!(ibv_mr_init_attr, access) - 8usize];
    ["Offset of field: ibv_mr_init_attr::comp_mask"]
        [::std::mem::offset_of!(ibv_mr_init_attr, comp_mask) - 16usize];
    ["Offset of field: ibv_mr_init_attr::iova"]
        [::std::mem::offset_of!(ibv_mr_init_attr, iova) - 24usize];
    ["Offset of field: ibv_mr_init_attr::addr"]
        [::std::mem::offset_of!(ibv_mr_init_attr, addr) - 32usize];
    ["Offset of field: ibv_mr_init_attr::fd"]
        [::std::mem::offset_of!(ibv_mr_init_attr, fd) - 40usize];
    ["Offset of field: ibv_mr_init_attr::fd_offset"]
        [::std::mem::offset_of!(ibv_mr_init_attr, fd_offset) - 48usize];
    ["Offset of field: ibv_mr_init_attr::dmah"]
        [::std::mem::offset_of!(ibv_mr_init_attr, dmah) - 56usize];
};
impl Default for ibv_mr_init_attr {
    fn default() -> Self {
        let mut s = ::std::mem::MaybeUninit::<Self>::uninit();
        unsafe {
            ::std::ptr::write_bytes(s.as_mut_ptr(), 0, 1);
...
pub enum ibv_query_qp_data_in_order_flags {
    ...
    IBV_QUERY_QP_DATA_IN_ORDER_DEVICE_ONLY = 2,
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
pub struct ibv_fd_arr {
    pub arr: *mut ::std::os::raw::c_int,
    pub count: u32,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ibv_fd_arr"][::std::mem::size_of::<ibv_fd_arr>() - 16usize];
    ["Alignment of ibv_fd_arr"][::std::mem::align_of::<ibv_fd_arr>() - 8usize];
    ["Offset of field: ibv_fd_arr::arr"][::std::mem::offset_of!(ibv_fd_arr, arr) - 0usize];
    ["Offset of field: ibv_fd_arr::count"][::std::mem::offset_of!(ibv_fd_arr, count) - 8usize];
};
...
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum ibv_tph_mem_type {
    IBV_TPH_MEM_TYPE_VM = 0,
    IBV_TPH_MEM_TYPE_PM = 1,
}
#[repr(u32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub enum ibv_dmah_init_attr_mask {
    IBV_DMAH_INIT_ATTR_MASK_CPU_ID = 1,
    IBV_DMAH_INIT_ATTR_MASK_PH = 2,
    IBV_DMAH_INIT_ATTR_MASK_TPH_MEM_TYPE = 4,
}
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
    ["Size of ibv_dmah_init_attr"][::std::mem::size_of::<ibv_dmah_init_attr>() - 12usize];
    ["Alignment of ibv_dmah_init_attr"][::std::mem::align_of::<ibv_dmah_init_attr>() - 4usize];
    ["Offset of field: ibv_dmah_init_attr::comp_mask"]
        [::std::mem::offset_of!(ibv_dmah_init_attr, comp_mask) - 0usize];
    ["Offset of field: ibv_dmah_init_attr::cpu_id"]
        [::std::mem::offset_of!(ibv_dmah_init_attr, cpu_id) - 4usize];
    ["Offset of field: ibv_dmah_init_attr::ph"]
        [::std::mem::offset_of!(ibv_dmah_init_attr, ph) - 8usize];
    ["Offset of field: ibv_dmah_init_attr::tph_mem_type"]
        [::std::mem::offset_of!(ibv_dmah_init_attr, tph_mem_type) - 9usize];
};
#[repr(C)]
#[derive(Debug, Default, Copy, Clone)]
...
unsafe extern "C" {
    #[doc = " ibv_import_pd - Import a protection domain"]
    pub fn ibv_import_pd(context: *mut ibv_context, pd_handle: u32) -> *mut ibv_pd;
}
unsafe extern "C" {
    #[doc = " ibv_unimport_pd - Unimport a protection domain"]
...
unsafe extern "C" {
    pub fn ibv_reg_mr_ex(pd: *mut ibv_pd, mr_init_attr: *mut ibv_mr_init_attr) -> *mut ibv_mr;
}
#[repr(i32)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
...
unsafe extern "C" {
    #[doc = " ibv_alloc_dmah - Allocate a dma handle"]
    pub fn ibv_alloc_dmah(
        context: *mut ibv_context,
        attr: *mut ibv_dmah_init_attr,
    ) -> *mut ibv_dmah;
}
unsafe extern "C" {
    #[doc = " ibv_dealloc_dmah - Free a dma handle"]
    pub fn ibv_dealloc_dmah(dmah: *mut ibv_dmah) -> ::std::os::raw::c_int;
}
unsafe extern "C" {
